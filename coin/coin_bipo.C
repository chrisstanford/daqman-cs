...
void search(const char *fname){
  ...
  TH2F *hgamma = new TH2F("GammaCoin", "Fp vs NPE for Gamma", 10000,0,20000, 220,0,1.1);
  TH2F *halpha = new TH2F("AlphaCoin", "Fp vs NPE for Alpha", 100,0,100, 220,0,1.1);
  ...
  ht->SetDirectory(0);
  ha->SetDirectory(0);
  TH2F *hmt = new TH2F("AlphaMT", "MT vs NPE for Alpha", 5000,0,20000, 500,0,10);
  hmt->SetDirectory(0);
